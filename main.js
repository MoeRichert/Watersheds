...
function fineDetails(){
    ...
    function findDownstream(e) {
        ...
        // TEST CODE Iterative function to implement Binary Search
           /* function getHucIndex(target, x) {
            arr=target.getLayers();
                ...
                while (start<=end){
                    ...
                    if (arr[mid].feature.properties.huc===x) return mid;

                    // Else look in left or right half accordingly
                    else if (arr[mid].huc < x) 
                         start = mid + 1;
                    else
                         end = mid - 1;
                }
