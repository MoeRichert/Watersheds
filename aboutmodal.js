          ...
          <Modal dialogClassName="my-modal"
              ...
              onHide={props.handleModalOpen}>
                    <Modal.Header
                        ...
                        style={{
                            backgroundColor: props.theme.midgrey,
                        }}
                        >
                 ...
                 <Modal.Title className="titlemodal" 
                     style={{color: props.theme.text,
                              margin: "0 auto",
                            }}>Where Does the Water Go?</Modal.Title>
              </Modal.Header>
              <Modal.Body >
                  <Carousel fade>
                    <Carousel.Item>
                          <Container>
                              <Row>
                                  <Col md="12" lg="5" style={{color:props.theme.body}}>
                                      <h3>This map is still under construction</h3>
                                      <p></p>
                                      <div className="about-content">
                                      <p>Thanks for checking out my map!</p>
                                      <p></p>
                                      <p>This map is still in progress, but feel free to explore</p>
                                      <p></p>
                                      <p></p>
                      ...
                      <Carousel.Item>
                          <Container>
                              <Row>
                                  <Col md="12" lg="5" style={{color:props.theme.body}}>
                                      <h3>Why does that matter?</h3>
                                      <p></p>
                                      <div className="about-content">
                                      <p>It's not just water that ends up in the waterway!</p>
                                      <p></p>
                                      <p>It's everything the water carries with it.</p>
                                      <p></p>
...
const domContainer = document.querySelector('#reactmodal');
ReactDOM.render(e(AboutModal), domContainer);
